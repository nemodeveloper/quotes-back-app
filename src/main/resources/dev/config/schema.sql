...
CREATE SEQUENCE IF NOT EXISTS quotes_author_id_seq CACHE 1000;
...
CREATE SEQUENCE IF NOT EXISTS quotes_category_id_seq CACHE 100;
...
CREATE SEQUENCE IF NOT EXISTS quotes_quote_id_seq CACHE 1000;